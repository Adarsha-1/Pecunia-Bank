...
import com.capgemini.pecunia.entity.UserTransactions;
...
public class TranscationServiceImpl implements TranscationService {
	...
	@Override
	public UserTransactions getAllTranscations(long accountNo) {
		List<Transcation> list=transcationRepository.getAllTransactionsByAccountNo(accountNo);
		return new UserTransactions(list);
	}
